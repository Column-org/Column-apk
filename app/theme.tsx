                ...
                <View style={styles.themeSection}>
                    ...
                    <View style={styles.themeOptions}>
                        ...
                        <TouchableOpacity
                            style={[
                                styles.themeCard,
                                selectedTheme === 'parthenon' && styles.themeCardActive
                            ]}
                            onPress={() => handleSaveTheme('parthenon')}
                            activeOpacity={0.8}
                        >
                            <Image
                                source={require('../assets/parthenon.png')}
                                style={styles.themeImage}
                                resizeMode="cover"
                            />
                            {selectedTheme === 'parthenon' && (
                                <View style={styles.selectedBadge}>
                                    <Ionicons name="checkmark-circle" size={24} color="#ffda34" />
                                </View>
                            )}
                            <View style={styles.themeOverlay}>
                                <Text style={styles.themeName}>Parthenon</Text>
                            </View>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity
                            style={[
                                styles.themeCard,
                                selectedTheme === 'catbg' && styles.themeCardActive
                            ]}
                            onPress={() => handleSaveTheme('catbg')}
                            activeOpacity={0.8}
                        >
                            <Image
                                source={require('../assets/catbg.gif')}
                                style={styles.themeImage}
                                resizeMode="cover"
                            />
                            {selectedTheme === 'catbg' && (
                            ...
                            <View style={styles.themeOverlay}>
                                <Text style={styles.themeName}>Cat</Text>
                            </View>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity
                            style={[
                                styles.themeCard,
                                selectedTheme === 'parthenon3' && styles.themeCardActive
                            ]}
                            onPress={() => handleSaveTheme('parthenon3')}
                            activeOpacity={0.8}
                        >
                            <Image
                                source={require('../assets/Parthenon3.webp')}
                                style={styles.themeImage}
                                resizeMode="cover"
                            />
                            {selectedTheme === 'parthenon3' && (
                                <View style={styles.selectedBadge}>
                                    <Ionicons name="checkmark-circle" size={24} color="#ffda34" />
                                </View>
                            )}
                            <View style={styles.themeOverlay}>
                                <Text style={styles.themeName}>Parthenon 3</Text>
                            </View>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity
                            style={[
                                styles.themeCard,
                                selectedTheme === 'grassroot' && styles.themeCardActive
                            ]}
                            onPress={() => handleSaveTheme('grassroot')}
                            activeOpacity={0.8}
                        >
                            <Image
                                ...
                                resizeMode="cover"
                            />
                            {selectedTheme === 'grassroot' && (
                                <View style={styles.selectedBadge}>
                                    <Ionicons name="checkmark-circle" size={24} color="#ffda34" />
                                </View>
                            )}
                            <View style={styles.themeOverlay}>
                                <Text style={styles.themeName}>Grassroot</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                </View>
